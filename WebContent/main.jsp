...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/js/topMenu.js"></script>
        ...
        <div class="ax-split-panel text-align-right">
            ...
            <div class="ax-split-col ax-frame-user-info">
                <div class="ax-split-panel">
                    <a href="<%=request.getContextPath()%>/?language=en">English</a> / <a href="<%=request.getContextPath()%>/?language=ko">한국어</a>
                </div>
                ...
                <!-- 개발자 툴 연결 아이콘
                <div class="ax-split-panel">
                    <a href="#ax" onclick="window.open('/jsp/system/system-dev-tools.jsp');"><i class="cqc-tools"></i> DevTools</a>
                </div>
                <div class="panel-split"></div>
                -->
                ...
                <!--사용자 정보 팝업 구현 안되어있음-->
                <div class="ax-split-panel">
                    <a href="#ax" onclick="fcObj.open_user_info();">시스템 관리자</a>
                </div>
                <div class="panel-split"></div>
                <div class="ax-split-panel">

                    <a href="#ax" class="ax-frame-logout" onclick="location.href = '<%=request.getContextPath()%>/Logout.do?action=Logout';">
                        <i class="cqc-log-out"></i> Logout
                    </a>
                </div>
            </div>
    ...
    <div class="ax-split-col" style="height: 100%;">
        ...
        <div class="ax-split-panel cell-logo">
            <a href="<%=request.getContextPath()%>/main.jsp">
                <img src="<%=request.getContextPath()%>/assets/images/header-logo.png" width="100%"/>
            </a>
        </div>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/window_instance.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/js/view/frame.js"></script>
