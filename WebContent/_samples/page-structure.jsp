...
<div id="ax-base-root" data-root-container="true">
    <div class="ax-base-title" role="page-title">
        <h1 class="title"><i class="cqc-browser"></i> Page Structure</h1>
        <p class="desc"></p>
    </div>
    <div class="ax-base-content">
        ...
        <div class="ax-button-group">
            <div class="left">
                <h2><i class="cqc-checkmark"></i> Basic Page Structure </h2>
            </div>
        </div>
        <pre>
...
&lt;/ax:layout>
        ...
        <div class="alert alert-info">
            ...
            <br/> 커스텀 태그는 WEB-INF > tags 아래에 *.tag 파일들로 원하는 태그를 직접 만들어 사용할 수 있습니다.
            <br/> AXBOOT에서는 웹 애플리케이션 개발에 필요한 커스텀 태그를 미리 만들어 제공하고 있습니다. AXBOOT의 커스텀 태그를 이용하여 개발에 날개를 달아보세요. 다음은 몇가지 커스텀 태그 샘플을 소개 하겠습니다.
        </div>
        <div class="ax-button-group">
            <div class="left">
...
&lt;/ax:form>
        ...
        <div class="alert alert-info">
            ...
            <br/> ax:table은 반응형 테이블 퍼블리싱을 지원합니다. ax:td의 width는 라벨을 포함한 너비값이 되고 라벨의 너비를 조정해야 할 때엔 labelWidth 속성을 부여해야 합니다. 라벨의 너비는 ax:table이 사용하는 CSS클래스에 정의되어 있으며 [data-ax-tbl] 으로 찾을 수 있습니다.
        </div>
