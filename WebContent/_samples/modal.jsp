...
<body class="ax-body baseStyle" data-page-auto-height="true">
<div id="ax-modal-base-root" data-root-container="true">
    <div class="ax-base-title" role="page-title">
        <h1 class="title">
            <i class="cqc-browser"></i> Search Code
        </h1>
    </div>
    <div class="ax-base-content">
        <div data-page-buttons="">
            <div class="button-warp">
                <button type="button" class="btn btn-default" data-page-btn="close">Close</button>
                <button type="button" class="btn btn-info" data-page-btn="search">Search</button>
                <button type="button" class="btn btn-fn1" data-page-btn="choice">Choose</button>
            </div>
        </div>
        ...
        <div data-ax5layout="ax1" role="page-content" data-config='{layout:"split-panel", orientation: "vertical", splitter: {size: 7}}' style="">
            <div data-split-panel='{width: "*"}' id="">
                <div style="padding-right: 0px;" class="" data-split-panel-wrap="">
                    <div class="ax-button-group" data-fit-height-aside="grid-view-01">
                        <div class="left">
                            <h2><i class="cqc-list"></i> List </h2>
                        </div>
                        <div class="right">
                        </div>
                    </div>
...
<script type="text/javascript" src="/assets/js/view/_samples/modal.js"></script>
</body>
