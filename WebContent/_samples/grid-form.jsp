...
<head>
    ...
    <title>Grid&Form Template</title>
...
<div id="ax-base-root" data-root-container="true">
    <div class="ax-base-title" role="page-title">
        <h1 class="title"><i class="cqc-browser"></i> Grid&Form Template</h1>
        <p class="desc"></p>
    </div>
...
<script type="text/javascript" src="/assets/js/view/_samples/grid-form.js"></script>
</body>
