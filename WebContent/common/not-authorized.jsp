...
<body class="ax-body error-page">
<div class="robotpage-top-half">
    <div id="robot_holder">
        <?xml version="1.0" encoding="utf-8"?>
        <!-- Generator: Adobe Illustrator 18.1.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
        <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
        <svg id="brokebotSVG" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 551 239" enable-background="new 0 0 551 239" xml:space="preserve" preserveAspectRatio="xMidYMax">
...
<div class="robotpage-bottom-half">
    <div>
        ...
        <div style="margin-top: 150px;">
            ...
            <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
            <svg version="1.1" id="chequer-logo" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="60px" height="60px" viewBox="-329 206.863 181.417 181.417" style="enable-background:new -329 206.863 181.417 181.417;" xml:space="preserve">
                    <g>
...
<script type="text/javascript" src="/assets/js/common/brokebot.min.js"></script>
</body>
