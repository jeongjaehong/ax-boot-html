...
<TABLE border=0 height=600px align=left>
	<TR>
		...
		<TD width=770px align=left valign=top><IFRAME ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=600px SRC="core/standardData.jsp"></IFRAME></TD>
	</TR>
</TABLE>
