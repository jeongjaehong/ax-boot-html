...
<body>
	<h1 class="samples">
		<a href="index.jsp">CKEditor Samples</a> &raquo; User Interface Languages
	</h1>
	<div class="warning deprecated">
		This sample is not maintained anymore. Check out its <a href="http://sdk.ckeditor.com/samples/uilanguages.jsp">brand new version in CKEditor SDK</a>.
	</div>
