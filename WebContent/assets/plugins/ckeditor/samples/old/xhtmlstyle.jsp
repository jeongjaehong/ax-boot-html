...
<body>
	<h1 class="samples">
		<a href="index.jsp">CKEditor Samples</a> &raquo; Producing XHTML Compliant Output
	</h1>
	<div class="warning deprecated">
		This sample is not maintained anymore. Check out its <a href="http://sdk.ckeditor.com/samples/basicstyles.jsp">brand new version in CKEditor SDK</a>.
	</div>
