...
<body>
	<h1 class="samples">
		<a href="../index.jsp">CKEditor Samples</a> &raquo; Producing Flash Compliant HTML Output
	</h1>
	...
	<div class="description">
		<p>
			...
			<a class="samples" href="http://www.adobe.com/livedocs/flash/9.0/main/wwhelp/wwhimpl/common/html/wwhelp.htm?context=LiveDocs_Parts&amp;file=00000922.jsp">
			Adobe Flash</a>.
				...
				<script>
					...
					function configureFlashOutput( ev ) {
						var editor = ev.editor,
							...
							htmlFilter = dataProcessor && dataProcessor.jspFilter;
