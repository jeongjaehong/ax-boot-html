...
<body>
	<h1 class="samples">
		<a href="../index.jsp">CKEditor Samples</a> &raquo; Toolbar Configuration
	</h1>
	<div class="warning deprecated">
		This sample is not maintained anymore. Check out the <a href="../../toolbarconfigurator/index.jsp#basic">brand new CKEditor Toolbar Configurator</a>.
	</div>
