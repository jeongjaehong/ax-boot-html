...
<body>
	<h1 class="samples">
		<a href="index.jsp">CKEditor Samples</a> &raquo; TAB Key-Based Navigation
	</h1>
	<div class="warning deprecated">
		This sample is not maintained anymore. Check out its <a href="http://sdk.ckeditor.com/samples/tabindex.jsp">brand new version in CKEditor SDK</a>.
	</div>
