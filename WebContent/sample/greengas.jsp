...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/sample/assets/plugins/realgrid/greengas.js"></script>
...
<div class="page-root">
    <div class="page-title">
        <div class="left"><i class="icon icon-open-book"></i>&nbsp;<h1>온실가스배출</h1></div>
        <div class="right">
                ...
                <div class="pad-cont full-height">
                    <div class="pad">
                        ...
                        <div class="pad-body with-head">
                            ...
                            <div class="pad-row">
                                <div class="la-input-group">
                                    <label for="input-1-1">시설명</label>
                                    <input type="text" id="input-1-1" class="la-input" style="width:130px;" />
                                    <a href="#" class="la-button primary"><i class="icon icon-magnifying-glass"></i>&nbsp;<span class="text">시설명 찾기</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div data-split-panel="{height: '*'}">
                ...
                <div class="pad-cont full-height">
                    <div class="pad" style="overflow: hidden;">
                        <div class="pad-head">
                            <div class="left"><span class="title">배출량 목록</span></div>
