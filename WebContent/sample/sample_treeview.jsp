...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/sample/assets/plugins/realgrid/tests/samples.js"></script>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/sample/assets/plugins/realgrid/treeview.js"></script>
...
<div class="page-root">
    <div class="page-title">
        <div class="left"><i class="svg icon-rg"></i>&nbsp;<h1>샘플 - 트리뷰</h1></div>
        <div class="right">
