...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/sample/assets/plugins/realgrid/tests/samples-barcodes.js"></script>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/sample/assets/plugins/realgrid/barcodes.js"></script>
...
<div class="page-root">
    <div class="page-title">
        <div class="left"><i class="svg icon-rg"></i>&nbsp;<h1>샘플 - 바코드</h1></div>
        <div class="right">
