...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/sample/assets/plugins/realgrid/estimate.js"></script>
    <script type="text/javascript">
        ...
        window.addEventListener('DOMContentLoaded', function () {            
            createGrid1("realgrid-1");
            createGrid2("realgrid-2");
...
<div class="page-root">
    <div class="page-title">
        <div class="left"><i class="icon icon-clipboard"></i>&nbsp;<h1>견적서</h1></div>
        <div class="right">
            <div class="la-button-group">
                ...
                <a href="#" class="la-button large"><i class="icon icon-print"></i>&nbsp;<span class="text">견적서 출력</span></a>
    ...
    <div class="page-fixed with-title">
        ...
        <div data-lolayout="row-1" data-config="{layout:'split-panel', orientation: 'horizontal'}">
            <div data-split-panel="{height: '130', minHeight:50}">
                    ...
                    <div class="pad">
                        ...
                        <div class="pad-body with-head">
                            ...
                            <div class="pad-row">
                                ...
                                <div class="la-input-group">
                                    <label for="input-2-2">비고</label>
                                    <input type="text" id="input-2-2" class="la-input" style="width:130px;" />
                                </div>
                                <div class="la-input-group">
                                    <label for="input-2-3">견적명</label>
                                    <input type="text" id="input-2-3" class="la-input" style="width:130px;" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div data-split-panel="{height: '*'}">
                ...
                <div class="pad-cont full-height">
                    <div class="pad" style="overflow: hidden;">
                        <div class="pad-head">
                            <div class="left"><span class="title">견적서 목록</span></div>
                        ...
                        <div class="pad-body with-head">
                            ...
                            <div id="realgrid-1" style="width:100%; height:100%;"></div>
                        </div>
                    </div>
                </div>
            ...
            <div data-split-panel="{height: '300', minHeight:50}">
                <div class="pad-cont full-height">
                    <div class="pad" style="overflow: hidden;">
                        <div class="pad-head">
                            <div class="left"><span class="title">견적서 세부항목</span></div>
                            <div class="right"><span class="desc"><strong>RealGrid 2</strong> - v2.5.1</span></div>
                        </div>
                        <div class="pad-body with-head">
                            <style>
                            ...
                            <div id="realgrid-2" style="width:100%; height:100%;"></div>
                        </div>
                    </div>
                </div>
            </div>
