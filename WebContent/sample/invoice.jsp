...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/sample/assets/plugins/realreport/pdfkit.js"></script>
    <link href='<%=request.getContextPath()%>/sample/assets/plugins/realreport/lib/realreport.css' rel='stylesheet' />
    <script type="text/javascript" src="<%=request.getContextPath()%>/sample/assets/plugins/realreport/lib/realreport-lic.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/sample/assets/plugins/realreport/lib/realreport.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(document.body).ready(function () {
            var reportUrl = '<%=request.getContextPath()%>/sample/assets/plugins/realreport/account_bill.r2';
