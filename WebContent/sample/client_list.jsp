...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/sample/assets/plugins/luplino/luplino-modal/dist/luplino-modal.css"/>
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/sample/assets/plugins/luplino/luplino-mask/dist/luplino-mask.css"/>
    ...
    <script src="<%=request.getContextPath()%>/sample/assets/plugins/luplino/luplino-formatter/dist/luplino-formatter.js"></script>
    <script src="<%=request.getContextPath()%>/sample/assets/plugins/luplino/luplino-picker/dist/luplino-picker.js"></script>
    <script src="<%=request.getContextPath()%>/sample/assets/plugins/luplino/luplino-mask/dist/luplino-mask.js"></script>
    <script src="<%=request.getContextPath()%>/sample/assets/plugins/luplino/luplino-modal/dist/luplino-modal.js"></script>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/sample/assets/plugins/realgrid/editor.js"></script>
