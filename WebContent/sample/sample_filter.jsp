...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/sample/assets/plugins/realgrid/filter.js"></script>
...
<div class="page-root">
    <div class="page-title">
        <div class="left"><i class="svg icon-rg"></i>&nbsp;<h1>샘플 - 필터</h1></div>
        <div class="right">
